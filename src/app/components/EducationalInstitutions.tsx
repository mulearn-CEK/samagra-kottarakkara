...
export default function EducationalInstitutions() {
  ...
  const schoolsData: SchoolsData = {
    schools: [
        ...
        { name: "Mar Baselious Eng Medium L.P.S Pulamon", type: "Un aided" },
        { name: "Mannam Memmorial Eng Medium L.P.S Padinjattinkara", type: "Un aided" },
        { name: "St.George English Medium L.P.S Puthoor", type: "Un aided" },
        { name: "St.Thevedorse L.P.S Madhavassery", type: "Un aided" },
        { name: "St.Mary`s E.M.L.P.S Kizhakkekara", type: "Un aided" },
